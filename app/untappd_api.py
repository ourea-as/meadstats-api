...
class UntappdAPI:
    ...
    def __init__(self, client_id: str, client_secret: str, host: str = 'api.untappd.com', version: str = 'v4'):
    ...
    def user_info(self, username: str = None, compact: bool = False, access_token: str = None):
        """
